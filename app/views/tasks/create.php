...
<div class="p-8 max-w-4xl mx-auto w-full">
    <div class="bg-white neo-box p-8 rounded-sm">
        <h1 class="text-3xl font-black uppercase mb-8 border-b-4 border-black pb-4">Tambah Task Baru</h1>
        
        <form action="/taskmaster/task/create" method="POST" class="space-y-6">
            <div>
                <label class="block font-bold mb-2 text-lg">Judul Task *</label>
                <input type="text" name="title" required class="w-full p-3 border-4 border-black outline-none focus:shadow-[4px_4px_0px_#000] bg-gray-50 rounded-sm">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block font-bold mb-2 text-lg">Deadline (Opsional)</label>
                    <input type="date" name="deadline" class="w-full p-3 border-4 border-black outline-none focus:shadow-[4px_4px_0px_#000] bg-gray-50 rounded-sm">
                </div>
            </div>
            ...
            <div>
                <label class="block font-bold mb-2 text-lg">Deskripsi (Opsional)</label>
                <textarea name="description" rows="4" class="w-full p-3 border-4 border-black outline-none focus:shadow-[4px_4px_0px_#000] bg-gray-50 rounded-sm"></textarea>
            </div>

            <div class="flex gap-4 pt-4">
                <button type="submit" class="flex-1 bg-[#a3e635] text-black font-black text-xl py-4 neo-btn rounded-sm">SIMPAN TASK</button>
